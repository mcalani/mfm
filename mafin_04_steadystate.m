...
function [ys,params,check] = mafin_04_steadystate(ys,exo,M_,options_)
...
%-------------------------------------------------------------------------%
% plot(1:options_.irf,oo_.irfs.gdp_u_e_req)

run Load_params;

phi_f_base  = M_.params(loc(M_.param_names,'phi_f_base'));
phi_h_base	= M_.params(loc(M_.param_names,'phi_h_base'));
...
phi_f       = (phi_f_base+ccyb+ccybneutral) + 0.0433;
phi_h       = (phi_h_base+ccyb+ccybneutral)*0.6 + 0.0433;
ppi         = ppi_T;
